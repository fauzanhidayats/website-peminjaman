...
<body>
    <p class="judul">Surat Peminjaman Ruangan</p>

    <p>Dengan ini kami menyatakan bahwa peminjaman ruangan telah diajukan dengan rincian sebagai berikut:</p>

    <ul>
        <li><strong>Nama Peminjam:</strong> {{ $peminjaman->user->name ?? $peminjaman->user->username }}</li>
        <li><strong>Nama Ruangan:</strong> {{ $peminjaman->ruangan->nama_ruangan ?? '-' }}</li>
