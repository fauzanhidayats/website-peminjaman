...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Detail Pengembalian Ruangan</h1>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Informasi Pengembalian Ruangan</h4>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Nama Ruangan</th>
                                    <td>{{ $pengembalian->peminjamanRuangan->ruangan->nama_ruangan ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th>Tanggal Mulai Pinjam</th>
                                    <td>{{ $pengembalian->peminjamanRuangan->tgl_mulai ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th>Tanggal Selesai Pinjam</th>
                                    <td>{{ $pengembalian->peminjamanRuangan->tgl_selesai ?? '-' }}</td>
                                </tr>
                                <tr>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('pengembalian-ruangan.index') }}" class="btn btn-secondary">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
