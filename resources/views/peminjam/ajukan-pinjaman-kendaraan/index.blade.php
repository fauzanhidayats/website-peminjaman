...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Data Peminjaman Kendaraan Saya</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="#">Dashboard</a></div>
                <div class="breadcrumb-item">Peminjaman Kendaraan</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('peminjaman-kendaraan.index') }}" class="btn btn-primary">Ajukan
                                Peminjaman</a>
                        </div>
