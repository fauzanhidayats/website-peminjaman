...
class LaporanBarangController extends Controller
{
    ...
    public function laporanPeminjamanBarang(Request $request)
    {
        ...
        return view('admin.laporan-barang.peminjaman', compact('peminjaman'));
    }
    ...
    public function laporanPengembalianBarang(Request $request)
    {
        ...
        return view('admin.laporan-barang.pengembalian', compact('pengembalian'));
    }
    ...
    public function cetakPeminjamanBarangPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.laporan-barang.pdf_peminjaman', [
    ...
    public function cetakPengembalianBarangPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.laporan-barang.pdf_pengembalian', [
